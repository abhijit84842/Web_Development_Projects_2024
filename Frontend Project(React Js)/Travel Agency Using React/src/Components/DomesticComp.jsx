            ...
            <div className="slide-card">
              ...
              <div className="city-desc">
                <p>
                  ...
                  beautiful places in the middle of the Thar desert in
                  Rajasthan, the state known for its colourful festivals, forts,
                  arts, music, beautiful palaces
                </p>
              </div>
              <div className="blankdiv-2nd"></div>
              <div className="tour-price">
            ...
            <div className="slide-card">
              ...
              <div className="city-desc">
                <p>
                  ...
                  festive season, many of us have been contemplating travelling
                  to nearby places where one can enjoy with friends and family
            ...
            <div className="slide-card">
              ...
              <div className="city-desc">
                <p>
                  ...
                  North Indian state nestled in the Himalayas is basically
                  divided into two halves with Shimla, the capital in the centre
                </p>
              </div>
              <div className="blankdiv-2nd"></div>
              <div className="tour-price">
          ...
          <SwiperSlide>
            ...
            <div className="slide-card">
              ...
              <div className="city-desc">
                <p>
                  {" "}
                  Kashmir is a haven of natural beauty, often called "Paradise
                  on Earth." The shimmering Dal Lake, surrounded by houseboats
                  and floating gardens, adds a magical charm.
                </p>
              </div>
              <div className="blankdiv-2nd"></div>
              <div className="tour-price">
